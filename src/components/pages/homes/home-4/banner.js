...
import video from "../../../assets/img/banner/banner.mp4";
import brand1 from "../../../assets/img/brand/blum1.png";
    ...
    return (
        <div className="banner__four">
             <div className="bg-video">
                <video style={{'filter': 'brightness(50%)'}}autoPlay muted loop playsInline><source src={video} type="video/mp4" /></video>
            </div> 
                ...
                <div className="row">
                    <div className="col-xl-12">
                        <div className="banner__four-content">
                            ...
                            <div className="header__area-menubar-right-btn one">
                            <Link className="build_button" to="/request-quote">Demandez votre devis<i className="flaticon-right-up"></i></Link>
                            </div>
                            {/* <span className="subtitle wow fadeInLeft" data-wow-delay=".3s">Demandez votre devis<i className="flaticon-right-up"></i></span> */}
                                <h1 className="wow fadeInRight" data-wow-delay=".6s">L’excellence au cœur de votre cuisine</h1>
